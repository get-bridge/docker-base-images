...
target "java" {
  ...
  cache-from = [
    ...
    "type=registry,ref=127178877223.dkr.ecr.us-east-2.amazonaws.com/get-bridge/java/java/8:cache"
  ]
  cache-to = [
    "type=gha,scope=java/8,mode=max",
    "type=registry,ref=127178877223.dkr.ecr.us-east-2.amazonaws.com/get-bridge/java/java/8:cache,mode=max"
  ]
}
