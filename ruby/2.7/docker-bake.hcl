...
target "ruby" {
  ...
  cache-from = [
    ...
    "type=registry,ref=127178877223.dkr.ecr.us-east-2.amazonaws.com/get-bridge/ruby/ruby/2.7:cache"
  ]
  cache-to = [
    "type=gha,scope=ruby/2.7,mode=max",
    "type=registry,ref=127178877223.dkr.ecr.us-east-2.amazonaws.com/get-bridge/ruby/ruby/2.7:cache,mode=max"
  ]
}
